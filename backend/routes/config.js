...
const ENCRYPTED_CONFIG_KEYS = {
  ...
  MOVIE_NIGHT_XTREAM_URL_ENC: 'MOVIE_NIGHT_XTREAM_URL',
  MOVIE_NIGHT_XTREAM_USERNAME_ENC: 'MOVIE_NIGHT_XTREAM_USERNAME',
  MOVIE_NIGHT_XTREAM_PASSWORD_ENC: 'MOVIE_NIGHT_XTREAM_PASSWORD',
  MOVIE_NIGHT_M3U_URL_ENC: 'MOVIE_NIGHT_M3U_URL',
  MOVIE_NIGHT_CONTROL_URL_ENC: 'MOVIE_NIGHT_CONTROL_URL',
  MOVIE_NIGHT_CONTROL_TOKEN_ENC: 'MOVIE_NIGHT_CONTROL_TOKEN',
};
