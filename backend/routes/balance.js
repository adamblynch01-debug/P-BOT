...
const { requireAuth, requireAdmin, requireOwnerAdmin, requireDiscordLinked, requireCurrentDiscordMember, publicUser, botAuthorized, botAuthUnavailable } = require('../utils/auth');
...
router.post('/topup/create', requireAuth, requireCurrentDiscordMember, async (req, res) => {
  try {
